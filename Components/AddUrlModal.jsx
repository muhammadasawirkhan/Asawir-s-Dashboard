...
const AddUrlModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white flex flex-col rounded-lg p-6 w-[90%] max-w-md relative">
        ...
        <h2 className="text-[24px] text-[#F16A77] font-[400] mb-4 text-center">Add URL</h2>
        ...
        ></textarea>
        <label className='font-[400] text-[14px] mt-2'>Paste <span className='text-[14px] text-[#282828] font-[700]'>URL</span></label>
        <input type="url" placeholder="Enter URL here" className="mt-2 border p-3 rounded w-full mb-4" />
