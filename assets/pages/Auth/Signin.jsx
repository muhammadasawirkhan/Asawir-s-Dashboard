  ...
  return (
    <>
      ...
      <div className=' w-auto mx-auto md:w-[25%] z-[1]  items-center justify-center' style={{ boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.15)' }}>
        <div className='flex flex-col pt-10 pb-10 mt-auto md:mt-[251px] pb-4  justify-center items-center  w-full gap-3'>
          ...
          {/* <div className=' md:block absolute hidden md:bottom-[430px] z-[-1]'>
            <img src={Img} alt="" />
          </div> */}
        </div>
      </div>
